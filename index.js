const kg = [
  ...
  { id: 'hooks', neighbors: ['链表', '闭包'], data: '1、顺序存到链表中，所以 hooks 不能放到循环和条件块中。2、hooks 靠闭包实现状态读写。' },
  ...
  { id: '请求动画帧', neighbors: ['动画', 'FPS', '节流'], data: 'requestAnimationFrame的优势，由系统来决定回调函数的执行时机，不同刷新率会有不同的间隔。更节能、更流畅。应用于：1、JS 动画。2、计算 FPS。3、Scroll 节流等。' },
  { id: 'FPS', neighbors: ['卡顿'] },
