const kg = [
  ...
  { id: '异步', neighbors: ['callback', 'promise', 'async', '宏任务', '微任务', '队列', '事件循环', '单线程', '非阻塞', 'web worker'] },
  ...
  { id: '性能优化', neighbors: ['CSS 性能优化', 'JS 性能优化', 'React 优化', '构建优化', '加载优化'] },
  ...
  { id: '加载优化', neighbors: ['打包', '压缩', '非阻塞', '缓存', '懒加载', '白屏', 'SSR', '骨架屏'] },
  ...
  { id: '服务器', neighbors: ['静态服务器', '进程', '线程', '内存', 'Node.js', 'Docker'] },
