const kg = [
  ...
  { id: '排序', neighbors: ['冒泡', '选择', '归并', '快排'] },
  { id: '搜索', neighbors: ['顺序', '二分'] },
  { id: '分治', neighbors: ['二叉树', '归并', '快排'] },
  ...
  { id: '协商缓存', neighbors: ['etag', 'last-modified', 'if-none-match', 'if-modified-since'], data: 'etag 准确但是要计算，last-modified 不准确但不需要计算' },
  { id: 'etag', neighbors: ['签名'] },
  { id: 'cookie', neighbors: ['sessionid', 'session'] },
