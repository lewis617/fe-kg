const kg = [
  ...
  { id: '语法', neighbors: ['声明', '继承', '异步', '类型', '作用域', '精度', '优先级'] },
  ...
  { id: 'CSS', neighbors: ['兼容性', '响应式', 'CSS 基础', 'CSS 应用', 'CSS 性能优化'] },
  { id: 'CSS 基础', neighbors: ['BFC', '盒模型', 'CSS3 动画', 'CSS3 其他特性', 'CSS 预处理器', 'CSS 加载'] },
  { id: 'CSS 预处理器', neighbors: ['less', 'sass'] },
  { id: 'CSS 加载', neighbors: ['link', '@import'] },
  { id: '盒模型', neighbors: ['box-sizing'] },
  { id: 'CSS3 动画', neighbors: ['animation', 'transition'] },
  { id: 'CSS 应用', neighbors: ['布局', '清除浮动', 'CSS 画图', '空格'] },
  ...
  { id: 'CSS3 其他特性', neighbors: [ 'border-radius', 'box-shadow', 'text-shadow', 'text-overflow', 'transform', '媒体查询'] },
