const kg = [
  ...
  { id: '异步', neighbors: ['callback', 'promise', 'async', '宏任务', '微任务', '队列', '事件循环', '单线程', '非阻塞'] },
  ...
  { id: 'webpack', neighbors: ['loader', 'plugin', 'resolve'] },
  { id: 'plugin', neighbors: ['tree shaking', '多进程'] },
  { id: 'react', neighbors: ['DIFF', '虚拟 DOM', 'react16', '表单', '组件通信'] },
  ...
  { id: 'CSS', neighbors: ['兼容性', '响应式', 'CSS 属性', 'CSS 画图', '布局', 'CSS3', 'less'] },
  ...
  { id: 'CSS 属性', neighbors: ['display', 'postion', 'visibility', 'transform', 'float', 'box-sizing', 'viewport', 'white-space', 'word-space', 'letter-space', 'border-radius', '@import'] },
  ...
  { id: 'CSS 画图', neighbors: ['正方形', '箭头', '三角形', '省略号', '扇形'] },
  ...
  { id: 'CSS3', neighbors: ['animation', 'transition', 'border-radius', 'box-shadow', 'text-shadow', 'text-overflow', 'transform', '媒体查询'] },
  { id: 'transform', neighbors: ['translate', 'scale', 'rotate', 'skew', 'flex'] },
  ...
  { id: '选择器', neighbors: ['通配符选择器', '标签选择器', 'class 选择器', 'id 选择器', '属性选择器', '后代选择器', '子选择器', '一般兄弟选择器', '紧邻兄弟选择器'], data: '1、避免嵌套。2、避免通配符和属性选择器。3、避免id+class，多此一举' },
  ...
  { id: '内存泄露', neighbors: ['全局变量', '事件监听', '闭包', 'node-heapdump', 'memory 选项卡'] },
