const kg = [
  ...
  { id: 'React 优化', neighbors: ['SSR', '缓存', '懒加载', '不可变数据'] },
  ...
  { id: '预加载', neighbors: ['preload', 'prefetch', 'dns-prefetch'] },
  ...
  { id: 'get', neighbors: ['缓存'] },
  { id: 'HTTPS', neighbors: ['证书', 'secure'], data: 'https 中的非对称加密只是为了让服务端知道密码，对称加密才是真正用来加密传输内容的' },
  ...
  { id: '认证', neighbors: ['cookie', 'JWT', 'SSO'] },
  { id: 'session', neighbors: ['状态', '数据库', '内存', '分布式', 'sessionid'] },
  { id: 'JWT', neighbors: ['状态', 'expires'] },
  { id: '函数计算', neighbors: ['状态'] },
  { id: 'SSO', neighbors: [], data: '同域的 SSO 只需要将 cookie 种在一级域名下即可。不同域的 SSO，SSO 系统需要生成token重定向到原系统，原系统再向SSO系统验证 token 是否有效，有效就设置 session。' },
